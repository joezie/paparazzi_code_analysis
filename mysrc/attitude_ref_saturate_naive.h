...
//    }                                                           \
//  }
void SATURATE_SPEED_TRIM_ACCEL(double  _rate, double _accel, double _max_rate) {}
                                                     ...
                                                     struct FloatRefSat *sat)
{
  ...
  RATES_BOUND_BOX_ABS(*(struct GenericFloatStruct*)accel, *(struct GenericFloatStruct*)&sat->max_accel); // joezie 2019/11/19
